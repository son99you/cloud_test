...
public class ComCmcdSignguComboBoxTag extends RequestContextAwareTag {

//	private static final long serialVersionUID = -9202778299779483697L;

	@SuppressWarnings("unused")
	private static final Logger LOG = LoggerFactory.getLogger(ComCmcdSignguComboBoxTag.class);
	...
	private List<FwkDataEntity> cdValueListInqire(){
		...
		trans = comCmcdLegaldongService.legaldongSignguListInqire(parameterMap);		
...
//			sb.append("			$(\"#" + this.objectId + "\").msDropdown({roundedCorner: \"false\"}).data(\"dd\").destroy();								\r\n");
			...
			sb.append("				}else{																																				\r\n");
			sb.append("		 			var actionUrl = \"/com/cmcd/legaldongEmdListInqire\";																			\r\n");
