package com.eunwoosoft.ipro.masc.service.impl;
...
import com.eunwoosoft.ipro.masc.dao.IproMascMainPageDao;
import com.eunwoosoft.ipro.masc.service.IproMascMainPageService;

/**
 * <pre>
 * com.eunwoosoft.ipro.masc.service.impl 
 *    |_ IproMascMainPageServiceImpl.java
 * 
 * </pre>
...
@Service(value="iproMascMainPageService")
public class IproMascMainPageServiceImpl extends AbstractFwkService implements IproMascMainPageService{
	
	@Resource(name="iproMascMainPageDao")
	private IproMascMainPageDao iproMascMainPageDao;
	...
	public FwkTransferObject mainPageInqire(final FwkParameterMap parameterMap){
		...
		// 공고 업무 카운트 조회
		trans.put(IproMascMainPageService.PBLANC_JOB_CNT_LIST, iproMascMainPageDao.selectPblancJobCntInqire(parameterMap));
		// 공고 전 업무 카운트 조회
		trans.put(IproMascMainPageService.PBLANC_BEF_JOB_CNT_LIST, iproMascMainPageDao.selectPblancBefJobCntInqire(parameterMap));
		// 개찰 후 업무 카운트 조회
		trans.put(IproMascMainPageService.OPENG_AT_JOB_CNT_LIST, iproMascMainPageDao.selectOpengAfJobCntInqire(parameterMap));
		// 계약 업무 카운트 조회
		trans.put(IproMascMainPageService.CNTRCT_JOB_CNT_LIST, iproMascMainPageDao.selectCntrctJobCntInqire(parameterMap));
		
		// 부서별 발주계획 카운트 조회
		trans.put(IproMascMainPageService.DEPT_ACCTO_ORDER_PLAN_CNT_DETAIL, iproMascMainPageDao.selectDeptAcctoOrderPlanCntInqire(parameterMap));
		// 부서별 입찰공고 카운트 조회
		trans.put(IproMascMainPageService.DEPT_ACCTO_BID_PBLANC_CNT_DETAIL, iproMascMainPageDao.selectDeptAcctoBidPblancCntInqire(parameterMap));
		// 일반행정 카운트 조회
		trans.put(IproMascMainPageService.GNRL_ADMINIST_CNT_DETAIL, iproMascMainPageDao.selectGnrlAdministCntInqire(parameterMap));
		// 기타공고 카운트 조회
		trans.put(IproMascMainPageService.ETC_PBLANC_CNT_DETAIL, iproMascMainPageDao.selectEtcPblancCntInqire(parameterMap));
		...
		trans.put(IproMascMainPageService.MAIN_GNRL_NOTICE_LIST, iproMascMainPageDao.selectMainNoticeList(parameterMap));
		// 메인입찰공지
		parameterMap.put("P_ELPR_BSNO", "EB0001");
		parameterMap.put("P_NOTICE_CNT", "7");
		trans.put(IproMascMainPageService.MAIN_BID_NOTICE_LIST, iproMascMainPageDao.selectMainNoticeList(parameterMap));

		// 메인TAB 입찰공고
		parameterMap.put("P_BID_PROGRS_STTUS_CD", "PF20");
		parameterMap.put("P_NOTICE_CNT", "4");
		trans.put(IproMascMainPageService.MAIN_PBLANC_LIST, iproMascMainPageDao.selectMainPblancTabList(parameterMap));
		// 메인TAB 사전공고
		parameterMap.put("P_BID_PROGRS_STTUS_CD", "BP94");
		parameterMap.put("P_NOTICE_CNT", "4");
		trans.put(IproMascMainPageService.MAIN_BEFFAT_PBLANC_LIST, iproMascMainPageDao.selectMainBeffatPblancTabList(parameterMap));
	...
	public FwkTransferObject deptAcctoPblancList(final FwkParameterMap parameterMap){
		...
		if("AP".equals(parameterMap.get("PROSSESS_GUBUN"))){
			// 부서별공고 목록
			trans.put(IproMascMainPageService.DEPT_ACCTO_PBLANC_LIST, iproMascMainPageDao.selectDeptAcctoPblancList(parameterMap));
		}else if("AO".equals(parameterMap.get("PROSSESS_GUBUN"))){
			// 부서별 발주계획 목록
			trans.put(IproMascMainPageService.DEPT_ACCTO_PBLANC_LIST, iproMascMainPageDao.selectDeptAcctoOrderPlanList(parameterMap));
		}else if("GP".equals(parameterMap.get("PROSSESS_GUBUN"))){
			// 부서별 일반 공고 목록
			trans.put(IproMascMainPageService.DEPT_ACCTO_PBLANC_LIST, iproMascMainPageDao.selectDeptAcctoGnrlPblancList(parameterMap));
		}else if("GO".equals(parameterMap.get("PROSSESS_GUBUN"))){
			// 부서별 일반 발주계획 목록
			trans.put(IproMascMainPageService.DEPT_ACCTO_PBLANC_LIST, iproMascMainPageDao.selectDeptAcctoGnrlOrderPlanList(parameterMap));
		}else if("EP".equals(parameterMap.get("PROSSESS_GUBUN"))){
			// 부서별 기타 공고 목록
			trans.put(IproMascMainPageService.DEPT_ACCTO_PBLANC_LIST, iproMascMainPageDao.selectDeptAcctoEtcPblancList(parameterMap));
		}else if("EO".equals(parameterMap.get("PROSSESS_GUBUN"))){
			// 부서별 기타 발주계획 목록
			trans.put(IproMascMainPageService.DEPT_ACCTO_PBLANC_LIST, iproMascMainPageDao.selectDeptAcctoEtcOrderPlanList(parameterMap));
		}
		return trans;
	}
	...
	public FwkTransferObject cldrCreatHtml(final FwkParameterMap parameterMap){
		...
		//// 1. 달력 사전공고 목록
		////List<FwkDataEntity> cldrBeffatPblancList = iproMascMainPageDao.selectCldrBeffatPblancList(parameterMap);
		// 1. 달력 기술평가 목록
		List<FwkDataEntity> cldrTchqvlnList = iproMascMainPageDao.selectCldrTchqvlnList(parameterMap);
		// 2. 달력 입찰공고 목록
		List<FwkDataEntity> cldrBidPblancList = iproMascMainPageDao.selectCldrBidPblancList(parameterMap);
		// 3. 달력 입찰설명회 목록
		List<FwkDataEntity> cldrBidDcPeoList = iproMascMainPageDao.selectCldrBidDcPeoList(parameterMap);
		// 4. 달력 참가마감 목록
		List<FwkDataEntity> cldrPareEndList = iproMascMainPageDao.selectCldrPareEndList(parameterMap);
		// 5. 달력 입찰서제출 목록
		List<FwkDataEntity> cldrBidDocsuList = iproMascMainPageDao.selectCldrBidDocsuList(parameterMap);
		// 6. 달력 개찰 목록
		List<FwkDataEntity> cldrOpengList = iproMascMainPageDao.selectCldrOpengList(parameterMap);
	...
	public FwkTransferObject toDoListCreatHtml(final FwkParameterMap parameterMap){
		...
		Map<String, Object> hMap = new HashMap<String, Object>();
		List<FwkDataEntity> toDoList = iproMascMainPageDao.selectToDoList(parameterMap);
		String classNm = "";
	...
	public String dbTime(final FwkParameterMap parameterMap) {
		return iproMascMainPageDao.selectDbTime(parameterMap);
	}
}
