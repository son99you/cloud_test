...
public interface IproEstmCmplDao {

	
	List<FwkDataEntity> selectEstmCmplList(final FwkParameterMap parameterMap);
	
	List<FwkDataEntity> selectEstmCmplListExcelDwld(final FwkParameterMap parameterMap);
	
	
	
	int selectEstmCmplListTotCnt(final FwkParameterMap parameterMap);
	
	FwkDataEntity selectEstmMngMstDetail(final FwkParameterMap parameterMap);
	FwkDataEntity selectEstmPayData(final FwkParameterMap parameterMap);
	FwkDataEntity selectEstmCmtmDetail(final FwkParameterMap parameterMap);
	...
	List<FwkDataEntity> selectCmtmExbePayList(final FwkParameterMap parameterMap);
	...
	void updateEstmCmtmExbePayUpdt(final FwkParameterMap parameterMap);
	void insertEstmCmplExbePaySave(final FwkParameterMap parameterMap);
	...
	void deleteEndCnclUpdt(final FwkParameterMap parameterMap);

	void deleteEndCnclScr(final FwkParameterMap parameterMap);
