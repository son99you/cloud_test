...
'spanish':{
	...
	"Menu_SAVE": "Salvar", 
	"Menu_PRINT": "Impresión", 
	
	"StreamingMsg": "informe de streaming se está generando ...",
	"StreamingMsg2": "página está generando...",
	"CompleteMsg": "La generación de informes de streaming está completa.",
	"CreateErrMsg": "El informe no fue generado.",
	"TotalpageErrMsg": "Total page request error.",
	"UnknownErrMsg": "Un error desconocido ocurrió.",
	"ErrMsg": "Ha ocurrido un error.",
	
	"ExportMsg" : "Creando archivo.",
	"ExportMsg2" : "Este tipo de exportación no es compatible con UbiViewer.",
	"StatusWaitMsg" : "Por favor espera.",
	
	"PrintDlgTitle": "Ingrese la página para imprimir",
	"PrintDlgRange": "Rango de páginas",
	"PrintDlgAll": "todas las páginas", 
	"PrintDlgCurrent": "página actual", 
	"PrintDlgFromTo": "páginas para imprimir", 
	"PrintDlgFrom": "~", 
	"PrintDlgTo": ".", 
	"PrintDlgMent": "※ Puedes imprimir solo parte de la página.",
	"PrintDlgMaxMent" : "Páginas máximas : ",
	"PrintDlgHMent": "Vista preliminar de impresión horizontal desde Internet Explorer",
	"PrintDlgHMent2": "Imprime cambiando la orientación del papel en las opciones.",
	"PrintDlgLink": "Lee más",
	
	"PrintDlgHTMLRangeErr": "Fuera del rango de impresión HTML.",
	"PrintDlgRangeErr": "Fuera de rango de página.",
	"PrintDlgEnter": "\nPor favor ingrese nuevamente.",

	"Button_OK": "De acuerdo",
	"Button_Cancel": "Cancelar",
	
	"PdfCheckMsg9": "Adobe Reader no está instalado o es una versión inferior.",
	"PdfCheckMsg6": "Adobe Reader no está instalado o es una versión inferior.",
	...
	"PdfDownloadMsg" : "Su navegador actual (^ browser ^) <b> descargará el archivo PDF </b>. <br> Si desea imprimir, guarde el archivo con el <b> botón Guardar </b> y luego imprima.",
	"PdfInstallMsg1" : "<b> No se pudo encontrar Adobe Reader en el navegador actual. </b>",
	"PdfInstallMsg2" : "<b> La versión de Adobe Reader actualmente instalada es baja o no está instalada correctamente. </b>",
	"PdfInstallMsg3" : "Debe instalar <b> Adobe Reader versión 10 o posterior </b> para imprimir. <br> Cierre el navegador e instálelo a través del siguiente sitio web.<a style='color:red; text-decoration:none;' href='https://get.adobe.com/kr/reader' target='_blank'>https://get.adobe.com/kr/reader</a><br>Si quieres imprimir sin instalar <b> Guardar botón </b>y luego imprimir.",
	"SaveFileMsg1" : "&nbsp; ※ Descarga el archivo a tu PC sin necesidad de instalación.",
	"SaveFileMsg2" : "&nbsp;※ Guarde los archivos utilizando el módulo UbiViewer. <br>&nbsp;  Si el módulo UbiViewer no está instalado, la instalación continuará.",
	...
	"PrintPDFTitle" : "Guía de impresión en PDF",
	"PrintHTMLTitle" : "Guía de impresión en HTML",
	"PrintHTMLMsg_Edge" : "Configure 'Encabezados y pies de página' en 'Desactivado' antes de imprimir.",
	"PrintHTMLMsg_FF" : "Necesita la configuración del navegador antes de imprimir.<br>El menú [Archivo] del navegador > Configuración de página > Márgenes y pestaña Encabezado / Pie de página. Y establezca 'Encabezados y pies de página' en '-blank-'.",
	"PrintHTMLMsg_Chrome" : "Haga clic en 'Más configuraciones' y desmarque la opción 'Encabezados y pies de página' antes de imprimir y presione el botón Imprimir.",
	"PrintHTMLMsg_Opera" : "Haga clic en 'Más opciones' y desmarque la opción 'Encabezados y pies de página' antes de imprimir y presione el botón Imprimir.",
	"PrintHTMLMsg_IE" : "Necesita la configuración del navegador antes de imprimir.<br>El menú [Archivo] del navegador > Configuración de página > Márgenes y pestaña Encabezado / Pie de página. Y establezca 'Encabezados y pies de página' en '-blank-'.",
	"PrintHTMLMsg_IEObj" : "Haga clic en el botón 'Configurar página(Alt + U)' antes de imprimir. Y establezca 'Encabezados y pies de página' en 'Vaciar'.",
	
	"ExportOption" : "Guardar opciones",
	"ExportFormat" : "Formato",
	"TiffOption" : "Tipo de compresión TIFF",
	"TiffPageOption" : "Crear Tiff imagen por página",
...
'arabic':{
	...
	"PrintDlgTitle": "تعيين نطاق الطباعة",
	"PrintDlgRange": "نطاق الصفحة",
	"PrintDlgAll": "الكل", 
	"PrintDlgCurrent": "الصفحة الحالية", 
	"PrintDlgFromTo": "صفحات للطباعة", 
	"PrintDlgFrom": "~", 
	"PrintDlgTo": ".", 
	"PrintDlgMent": "※ You can print only a part page.",
	"PrintDlgMaxMent" : "Maximum pages : ",
