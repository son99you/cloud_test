...
function checkPinLang(index) {
    ...
    var text = [
        ...
        [
            ...
            " * Letters are large / lower case delimited<br>",
            ...
            "Enter the password has been canceled by the user.",   // 16
            "Caution alerts"
        ],
        [
            'パスワードを入力',
            ...
            "パスワードの入力がユーザーによってキャンセルされました。",   // 16
            "注意事項通知"
        ],
        [
            '密碼',
