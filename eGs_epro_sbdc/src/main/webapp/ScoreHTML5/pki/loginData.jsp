...
<%--                </div>--%>
                <div class="form-group actions">
                    ...
                    <div class="col-sm-10">
                        <button onclick="MakeLoginData();" class="btn btn-primary">로그인 데이터 생성</button>
                    </div>
                </div>
            </form>
        </div>
...
<script>
    function loginData_complete_callback(res) {
        if (res.code == 0) {
    ...
    function MakeLoginData() {
        ...
        var loginDataKmCert = tsHTML5PKIConfig.pki.common.loginDataKmCert;
        ...
        //if(verifyVID == true) {
            ...
            //}
        //}
        tsHTML5PKI.loginData(sessionId, ssn, userInfo, options, loginData_complete_callback);
    }
