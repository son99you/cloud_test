...
(function() {
	...
	reloadDetail = function(){
		FwkCmmnUtil.submitForm("detailFrm", "/opro/estm/estmCmtmProgProcdADetail.do"); 
	};
	...
	detailInqirePopup = function(ESTM_OBJ_SEQ,ESTM_CMTM_NO,ESTR_SECD) {
		...
		$("#popupFrm input[name='reloadURL']").val("/opro/estm/estmCmtmProgProcdADetail.do");
		...
		$("#popupFrm").one("submit", function() {
			...
			this.action = FwkCmmnUtil['contextPath']+'/opro/comm/popup/estmCmtmEstmFrmRegForm.do';
	        this.method = 'POST';
