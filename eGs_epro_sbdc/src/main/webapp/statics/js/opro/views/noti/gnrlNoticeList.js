 ...
 * <pre>
 * unbb
 *    |_ oepUnbbGnrlNoticeList.js
 * 
 * </pre>
 * @date : 2015. 06. 01. 오전 11:34:00
 * @version : 1.0
 * @author : 은우소프트 전상훈
 */
...
(function() {
	...
	/**  
     * <pre>
     * 1. 개요 : 일반 공지사항 목록조회 Submit
     * 2. 처리내용 : 
     * 		일반 공지사항 목록 조회 Form 을 Sumit 한다.
     *  	
     * </pre>
	...
	pageObj.listInqire = function() {
		FwkCmmnUtil.submitForm(defaultFrm, "/opro/noti/gnrlNoticeList.do");

	};
	
	/**  
	 * <pre>
	 * 1. 개요 : 일반 공지사항 상세조회 페이지 이동
	 * 2. 처리내용 : 
	 * 		일반 공지사항 상세 조회 페이지로 이동한다.
	 *  	
	 * </pre>
	 ...
	 *  변경일             		작성자                     		변경내용  
	 *  =======================================================
	 *  2015. 05. 26.       은우소프트 전상훈              최초 작성 
	 *  =======================================================   
	 */
	detailInqire = function(nttSn) {
		$("#detailFrm input[name='P_NTT_SN']").val(nttSn);
		FwkCmmnUtil.submitForm("detailFrm", "/opro/noti/gnrlNoticeDetail.do");
	};
