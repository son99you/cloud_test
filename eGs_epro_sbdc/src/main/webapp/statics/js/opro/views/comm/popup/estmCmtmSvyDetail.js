(function() {
	...
	// 설문조사 저장
	pageObj.estmCmtmSvyRegist = function() {
		FwkCmmnUtil.submitForm("registFrm", "/opro/comm/popup/estmCmtmSvySave.do");
	};
	
	pageObj.estmCmtmSvyDetail = function(){
		FwkCmmnUtil.submitForm("registFrm", "/opro/comm/popup/estmCmtmSvyDetail.do");
	};
	...
	$(function() {		
		...
		/*if($("#resultCode").val() == 'Success'){
			FwkCmmnUtil.submitForm("registFrm", "/comm/popup/estmCmtmSvyDetail.do");
		}*/
