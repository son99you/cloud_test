...
(function() {
	...
	fileUploadStart = function() {
		...
		if (RAONKUPLOAD.GetTotalFileCount("upload") == 0) {
			FwkCmmnUtil.submitForm("updtFrm", "/estm/estmObjFileUpdt.do");
        } else {
	...
	$(function(){
		...
		fileModify("updtFrm", "P_FILE_GRP_NO", "P_FILE_GRP_NO_NEW", "/estm/estmObjFileUpdt.do", "updtFrm", "/comm/popup/estmObjFileView.do", "");
