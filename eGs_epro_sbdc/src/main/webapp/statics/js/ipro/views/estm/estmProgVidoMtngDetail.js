...
//	};
	...
	pageObj.createMeetingRoom = function(obj) {
		...
		FwkCmmnUtil.submitForm("meetFrm" , "/estm/createMeetingRoom.do");
	};
	...
	pageObj.setEventHandler = function() {
		...
		$(document).on("click","button[name='mtngPrtcRqs']", function() {
			...
			$("#popupFrm input[name='P_VIDO_ST_DT']").val($(this).parent().parent().find("#P_VIDO_ST_DT").val());
			$("#popupFrm input[name='P_VIDO_END_DT']").val($(this).parent().parent().find("#P_VIDO_END_DT").val());
			$("#popupFrm input[name='P_VIDO_MTNG_NM']").val($(this).parent().parent().find("input[name='P_VIDO_MTNG_NM']").val());
		...
		$("#saveBtn").on("click", function() {
			...
			FwkCmmnUtil.submitForm("detailFrm" , "/estm/estmProgVidoMtngSave.do");
		});
