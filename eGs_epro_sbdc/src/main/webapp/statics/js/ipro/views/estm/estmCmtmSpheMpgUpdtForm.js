(function() {
	...
	pageObj.estmCmtmSpheMpgUpdt = function() {
		...
		var actionUrl = "/estm/estmCmtmSpheMpgUpdt.do";
			...
			if(searchYn == "Y") {
				if(ESTM_CMTM_SPHE_ARR[i][4] == "N" ) {
					if(dataCmtmNm == searchCmtmNm
						...
						strHtmlOne  += "</td>";
						strHtmlOne  += "<td class=\"txt-center\">" + ESTM_CMTM_SPHE_ARR[i][1] + "</td>";
						strHtmlOne  += "<td class=\"txt-center\">" + ESTM_CMTM_SPHE_ARR[i][5] + "</td>";
					...
					strHtmlTwo  += "</td>";
					strHtmlTwo  += "<td class=\"txt-center\">" + ESTM_CMTM_SPHE_ARR[i][1] + "</td>";
					strHtmlTwo  += "<td class=\"txt-center\">" + ESTM_CMTM_SPHE_ARR[i][5] + "</td>";
...
//				console.log($(this).parent().parent().find($("input[name='D_SELECT_AT']")).val());
	...
	$(function() {		
		...
		$("input[name='D_ESTM_CMTM_NO']").each(function(i) {
			ESTM_CMTM_SPHE_ARR[i] = new Array(13);
