...
(function() {
	...
	pageObj.updtForm = function() {
		FwkCmmnUtil.submitForm("updtFrm", "/noti/rssUpdtForm.do"); 
	};
	...
	pageObj.rssDelete = function() {
		var jsonData = $("#updtFrm").serializeObject();
		var actionUrl = "/noti/rssDelete";
		...
		//FwkCmmnUtil.submitForm("updtFrm", "/noti/rssDelete.do");
	};
