...
(function() {
	...
	/**  
     * <pre>
     * 1. 개요 : 현장설명회 목록조회 Submit
     * 2. 처리내용 : 
     * 		- 현장설명회 목록 조회 Form 을 Sumit 한다.
     *  	
     * </pre>
	...
	pageObj.bidDcPeoList = function() {
		FwkCmmnUtil.submitForm(defaultFrm, "/ebid/bidDcPeoList.do");
	};
	
	/**  
	 * <pre>
	 * 1. 개요 : 현장설명회 상세조회 페이지 이동
	 * 2. 처리내용 : 
	 * 		- 현장설명회 상세 조회 페이지로 이동한다.
	 *  	
	 * </pre>
	 * @Function Name : bidDcPeoDetail
	 * @date : 2015. 02. 13
	 * @author : 은우소프트 손연우
	 * @history : 
	 *  =======================================================
	 ...
	 *  =======================================================   
	 */
	bidDcPeoDetail = function(pblancNo, pblancOdr, roundNo) {
		...
		FwkCmmnUtil.submitForm("viewFrm", "/ebid/bidDcPeoDetail.do");
	};
	...
	pageObj.chargerInqirePopup = function() {
		$("#popupFrm").one("submit", function() {
			window.open("", "chargerListPopup", "width=750,height=760px,toolbar=no,status=no,scrollbars=yes,resizeable=no,menubar=no,left=500,top=50");
	 ...
	 *   - 조회버튼에 click 이벤트 발생시 현장설명회 목록조회 함수를 호출한다.
	 * 2. 입찰명 : 엔터키 이벤트 핸들러
	...
	pageObj.setEventHandler = function() {
		...
		FwkCmmnUtil.setEnterKeyBinding(defaultFrm, [ "P_BID_NM_S", "P_ANNC_NO_S", "P_CONT_SECD_S", "P_SBID_MTCD_S", "P_BRFS_STDT_S", "P_BRFS_ENDT_S", "P_CHRGR_NM_S" ], function() {
