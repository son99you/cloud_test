(function() {
	...
	tabEvent = function(tab_no){
		...
		if(tab_no == "1"){   // 기본정보 
			...
			FwkCmmnUtil.submitForm("detailFrm", "/estm/estmCmtmProgProcdADetail.do?P_ESTM_PROCD_SEQ=1");
		}else if(tab_no == "3"){   // 품평회
			FwkCmmnUtil.submitForm("detailFrm", "/estm/estmCmtmProgProcdADetail.do?P_ESTM_PROCD_SEQ=2");
