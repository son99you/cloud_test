...
(function() {
	...
	pageObj.estmSlct = function() {
		FwkCmmnUtil.submitForm("detailFrm", "/estm/estmASlct.do"); 
	};
	
	pageObj.estmEnd = function() {
		FwkCmmnUtil.submitForm("detailFrm", "/estm/estmAEnd.do"); 
	};
	...
	reloadDetail = function(){
		FwkCmmnUtil.submitForm("detailFrm", "/estm/estmProgProcdADetail.do"); 
	};
