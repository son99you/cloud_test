			...
			for(var m = 0; m < colspanCnt; m++) {
				...
				if(colFirstYn == "Y") {
					...
					if(itemNo == "") {
						...
						{
							strHtml  += "<input type=\"hidden\" name=\"P_ESTM_DTL_ITEM_NO\">";
						}
						if(ESTM_DTL_ITEM_ARR[itemLine][1] != "" && ESTM_DTL_ITEM_ARR[itemLine][1] != null)
						{
							strHtml  += "<input type=\"text\" style=\"width : 70%;\" name=\"P_ESTM_DTL_ITEM_NM\" placeholder=\"평가항목명\" value=\"" + ESTM_DTL_ITEM_ARR[itemLine][1] + "\">";
						}else 
						{
							strHtml  += "<input type=\"text\" style=\"width : 70%;\" name=\"P_ESTM_DTL_ITEM_NM\" placeholder=\"평가항목명\">";
						}
						if(ESTM_DTL_ITEM_ARR[itemLine][2] != "" && ESTM_DTL_ITEM_ARR[itemLine][2] != null)
						{
							strHtml  += "<textarea style=\"width: 100%; height: 70px;\" placeholder=\"평가항목내용\" name=\"P_ESTM_ITEM_DTL_CNTN\">"+ ESTM_DTL_ITEM_ARR[itemLine][2] +"</textarea>";
						}else 
						{
							strHtml  += "<textarea style=\"width: 100%; height: 70px;\" placeholder=\"평가항목내용\" name=\"P_ESTM_ITEM_DTL_CNTN\"></textarea>";
						}
						if(ESTM_DTL_ITEM_ARR[itemLine][3] != "" && ESTM_DTL_ITEM_ARR[itemLine][3] != null)
						{
							strHtml  += "<input type=\"text\" style=\"width : 10%;\" name=\"P_ESTM_DTL_ITEM_SCR\" placeholder=\"배점\" numeric value=\"" + ESTM_DTL_ITEM_ARR[itemLine][3] + "\">";
						}else {
							strHtml  += "<input type=\"text\" style=\"width : 10%;\" name=\"P_ESTM_DTL_ITEM_SCR\" placeholder=\"배점\" numeric >";
						}
						...
						if(ESTM_DTL_ITEM_ARR[itemLine][4] != "" && ESTM_DTL_ITEM_ARR[itemLine][4] != null)
						{
							...
							{
								strHtml += "<select style=\"width : 80px;\" name=\"P_ESTM_DTL_ITEM_SCR_SECD\"><option value=\"A\" selected>합산</option><option value=\"B\">최고점</option></select>";
							}else if(ESTM_DTL_ITEM_ARR[itemLine][4] == "B")
							{
								strHtml += "<select style=\"width : 80px;\" name=\"P_ESTM_DTL_ITEM_SCR_SECD\"><option value=\"A\">합산</option><option value=\"B\" selected>최고점</option></select>";	
							}
							
						}else 
						{
							strHtml += "<select style=\"width : 80px;\" name=\"P_ESTM_DTL_ITEM_SCR_SECD\"><option value=\"A\">합산</option><option value=\"B\">최고점</option></select>";
						}
						strHtml += "&nbsp;&nbsp;";
