(function() {
	...
	tabEvent = function(tab_no){
		...
		if(tab_no == "1"){   // 기본정보 
			...
			FwkCmmnUtil.submitForm("detailFrm", "/estm/cmtmMngCmplProcdADetail.do?P_ESTM_PROCD_SEQ=1");
		}else if(tab_no == "5"){   // 품평회
			FwkCmmnUtil.submitForm("detailFrm", "/estm/cmtmMngCmplProcdADetail.do?P_ESTM_PROCD_SEQ=2");
		}else if(tab_no == "6"){   // 정량평가
			FwkCmmnUtil.submitForm("detailFrm", "/estm/cmtmMngCmplProcdBDetail.do");
