(function() {
	...
	//chargerListAdd = function(ccpyCnt, arr_deptNm, arr_userId, arr_usrNm, arr_mail, arr_telNo, arr_bizNm) {
	...
	pageObj.saveApplLine = function() {
		...
		var actionUrl = "/info/infoApprlineRegist";
