(function() {
	...
	//상세
	pageObj.estmSeMngDetail = function(){
		FwkCmmnUtil.submitForm("updtFrm", "/sytm/estmSeMngDetail.do");
	}
	
	pageObj.estmSeMngUpdt = function(){
		FwkCmmnUtil.submitForm("updtFrm", "/sytm/estmSeMngUpdt.do");
	};
...
//			}
	...
	$(function() {		
		...
		procdCnt = Number($("#seProcdListCnt").val()) + 1;
	});
