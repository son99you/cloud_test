...
<ul id="nxtsdemoinstall">
  ...
  <li> <a class="btn02" href="../../pki/">처음으로</a> <a class="btn02" href="/opro/main/emgncLoginForm.do" >뒤로</a><!-- <a class="btn02" href="window.history.back();" >뒤로</a> --> </li>
</ul>
	...
	$(document).ready(function(){
		function installComplete(res,data) {
			...
			if(res.code == nxTSError.res_success) {
				...
				window.location.href = "/opro/main/emgncLoginForm.do";
			}
		}
