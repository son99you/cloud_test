	...
	*/
	...
	event.addAfterUploadEventListener(new AfterUploadEventListener() {
		public void afterUploadEvent(EventVo eventVo) {
		    ...
		    System.err.println("strResponseFilePath : " + strResponseFilePath);
		    ...
		    eventVo.setServerDomain("http://localhost:8080"); //Image Tag의 src에 삽입될 url의 domain을 설정합니다. (/ 설정시 도메인 없이 Virtual Patht가 들어갑니다.) 예) eventVo.SetServerDomain("http://www.raonk.com");
	...
	editor.settingVo.setPhysicalPath("D:/koti/workspace/eCdocuDev/src/main/webapp/WEB-INF/jsp/raonkeditor/uploadimg");
	///////////////////////////////
	//      SMB Protocol 설정        //
	///////////////////////////////
