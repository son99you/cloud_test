...
<html lang="ko">
	...
	<script type="text/javascript" src="${contextPath}/statics/libs/jquery.popupWindow.js"></script>
	<script type="text/javascript" src="${contextPath}/statics/libs/jquery.ui.widget.js"></script>
