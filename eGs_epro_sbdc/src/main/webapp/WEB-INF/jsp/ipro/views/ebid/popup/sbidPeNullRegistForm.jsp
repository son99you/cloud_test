...
<script type="text/javascript" src="${jsPath}/ipro/views/ebid/popup/sbidPeNullRegistForm.js"></script> 
 
<div class="pop_wrap">
	<div class="pop_header">
		<h1 class="tit">낙찰자없음 등록</h1>
	</div> <!--// pop_header E -->
		...
		<div class="view_wrap typeC">
			<div class="view_area">
				<form id="registFrm"  method="POST" >
		    		...
		    		<input type="hidden" id="P_SBID_MTCD" name="P_SBID_MTCD" value="${bidPblancDetail.SBID_MTCD }">
		    		<input type="hidden" id="P_ROUND_NO" name="P_BID_PSCD" value="PF63">
					...
					<table class="table">
		                ...
		                <tr>
		                    <th scope="row" class="bullet_orange"><label for="P_PRTC_APLY_ENDT">입찰참가자격등록일시</label></th>
		                    <td colspan="3">
								<input type="text"  id="P_PRTC_APLY_ENDT" name="P_PRTC_APLY_ENDT" class="w120" date value="${comFn:formatDate(bidPblancDetail.PRTC_APLY_ENDT,'yyyyMMddHHmmss','yyyy-MM-dd')}">
		                        <span class="wave">&nbsp;</span>
		                        <input type="text" class="float-left" id="P_PRTC_APLY_ENDT_HH" name="P_PRTC_APLY_ENDT_HH" style="width: 50px" maxlength="2" numeric value="${comFn:formatDate(bidPblancDetail.PRTC_APLY_ENDT,'yyyyMMddHHmmss','HH')}"><span class="wave">:</span>
		                        <input type="text" class="float-left mr5" id="P_PRTC_APLY_ENDT_MM" name="P_PRTC_APLY_ENDT_MM" style="width: 50px" maxlength="2"  numeric value="${comFn:formatDate(bidPblancDetail.PRTC_APLY_ENDT,'yyyyMMddHHmmss','mm')}">
		                    </td>
		                </tr>
		                ...
		                <tr>
		                    ...
		                    <td colspan="3">
		                        ...
		                        <span class="wave">~</span>
		                        <div style="display: inline-block;">
				                    <input type="text"  id="P_BIDC_SBMT_ENDT" name="P_BIDC_SBMT_ENDT" class="w120" date  value="${comFn:formatDate(bidPblancDetail.BIDC_SBMT_ENDT,'yyyyMMddHHmmss','yyyy-MM-dd')}">
			                        <span class="wave">&nbsp;</span>
			                        <input type="text" class="float-left" id="P_BIDC_SBMT_ENDT_HH" name="P_BIDC_SBMT_ENDT_HH" style="width: 50px" maxlength="2" numeric  value="${comFn:formatDate(bidPblancDetail.BIDC_SBMT_ENDT,'yyyyMMddHHmmss','HH')}"><span class="wave">:</span>
			                        <input type="text" class="float-left" id="P_BIDC_SBMT_ENDT_MM" name="P_BIDC_SBMT_ENDT_MM" style="width: 50px" maxlength="2" numeric  value="${comFn:formatDate(bidPblancDetail.BIDC_SBMT_ENDT,'yyyyMMddHHmmss','mm')}">
		                        </div>
		                    </td>
		                </tr>
<!-- 		                <tr> -->
...
<!-- 		                </tr> -->
		                <tr>
		                    ...
		                    <td colspan="3">
			                    <input type="text"   id="P_OPNG_DT" name="P_OPNG_DT" class="w120" date  value="${comFn:formatDate(bidPblancDetail.OPNG_DT,'yyyyMMddHHmmss','yyyy-MM-dd')}">
		                        <span class="wave">&nbsp;</span>
		                        <input type="text" class="float-left" id="P_OPNG_DT_HH" name="P_OPNG_DT_HH" style="width: 50px" maxlength="2" numeric  value="${comFn:formatDate(bidPblancDetail.OPNG_DT,'yyyyMMddHHmmss','HH')}"><span class="wave">:</span>
		                        <input type="text" class="float-left" id="P_OPNG_DT_MM" name="P_OPNG_DT_MM" style="width: 50px" maxlength="2" numeric  value="${comFn:formatDate(bidPblancDetail.OPNG_DT,'yyyyMMddHHmmss','mm')}">
		                    </td>
		                </tr>
		                </c:if>
		                <c:if test="${bidPblancDetail.SBID_MTCD eq '70'}">
		                	<tr>
			                    <th scope="row" class="bullet_orange"><label for="P_PRTC_APLY_ENDT2">입찰참가자격등록일시</label></th>
			                    <td>
									<input type="text"  id="P_PRTC_APLY_ENDT2" name="P_PRTC_APLY_ENDT" class="w120" date value="${comFn:formatDate(bidPblancDetail.PRTC_APLY_ENDT,'yyyyMMddHHmmss','yyyy-MM-dd')}">
			                        <span class="wave">&nbsp;</span>
			                        <input type="text" class="float-left" id="P_PRTC_APLY_ENDT_HH2" name="P_PRTC_APLY_ENDT_HH" style="width: 50px" maxlength="2" numeric value="${comFn:formatDate(bidPblancDetail.PRTC_APLY_ENDT,'yyyyMMddHHmmss','HH')}"><span class="wave">:</span>
			                        <input type="text" class="float-left mr5" id="P_PRTC_APLY_ENDT_MM2" name="P_PRTC_APLY_ENDT_MM" style="width: 50px" maxlength="2"  numeric value="${comFn:formatDate(bidPblancDetail.PRTC_APLY_ENDT,'yyyyMMddHHmmss','mm')}">
			                    </td>
			                </tr>
		                	<tr>
			                    <th scope="row" class="bullet_orange"><label for="P_BIDC_SBMT_ENDT">역경매마감일시</label></th>
			                    <td colspan="3">
			                        <div style="display: inline-block;">
					                    <input type="text"  id="P_BIDC_SBMT_ENDT" name="P_BIDC_SBMT_ENDT" class="w120" date  value="${comFn:formatDate(bidPblancDetail.BIDC_SBMT_ENDT,'yyyyMMddHHmmss','yyyy-MM-dd')}">
				                        <span class="wave">&nbsp;</span>
				        ...
				        <tr>
				            <th class="bullet_orange">낙찰자없음 사유</th>
				            <td colspan="3">
			                    <label for="P_PROC_RSN" class="blind">낙찰자없음 사유</label>
...
<!-- 				<button type="button" class="btn btn_02 btn_revise" id="registBtn" >낙찰자 없음</button> -->
				<button type="button" class="btn btn_02 btn_revise" id="reBidBtn" >재공고</button>
