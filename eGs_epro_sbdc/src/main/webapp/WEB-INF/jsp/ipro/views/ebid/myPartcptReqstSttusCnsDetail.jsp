 ...
 * <pre>
 * ebid 
 *    |_ myPartcptReqstSttusCnsDetail.jsp
 *  
 * </pre>
 * @date : 2017. 06.20
 * @version : 1.0
...
<script type="text/javascript" src="${jsPath}/opro/views/ebid/myPartcptReqstSttusCnsDetail.js"></script> 
  
 
<div id="panelSubContent">
	<h3 class="subTitle">나의 참가신청 상세</h3>
	
        		<div class="processStep"> 
	            <div class="" id="biddingId">공고중</div>
                ...
                <img src="${imagePath}/opro/icon/ico_arrow.png" alt="다음 단계"> 
	            <div  class="on" id="opengComptId">개찰</div>
	        </div>
	...
	<div class="tableLayer">
		...
		<div class="T_btnLayer fr">
            <button type="button" class="blueBtn L" id="bidPareViewBtn"  >입찰참가신청서 보기</button>
	 		<button type="button" class="blueBtn L" id="cospViewBtn"  >공동수급협정서 보기</button>
...
<%--popup form --%>
<form id="popupFrm" method="POST" >	</form> <!-- 입찰참가신청서보기 -->
<form id="cospViewFrm" method="POST" ></form> <!-- 공동수급협정서보기 -->
<form id="bidPartcptAbandnFrm" method="POST" >	</form> <!-- 입찰포기신청 -->
