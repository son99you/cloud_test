...
<script type="text/javascript" src="${jsPath}/opro/views/comm/popup/estmCmtmMngCrtrDetail.js"></script>
		...
		<div class="table-detail">
			...
			<table class="component-detail-table type-line-none">
				...
				<tbody>
					...
					<tr>
						<th>전화번호</th>
						<td>${comFn:formatPhoneNumber(estmCmtmCrtrMstDetail.TEL_NO)}</td>
						<th>이메일</th>
