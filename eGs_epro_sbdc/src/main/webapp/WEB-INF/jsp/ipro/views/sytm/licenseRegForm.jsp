...
<script type="text/javascript" src="${jsPath}/ipro/views/sytm/licenseRegForm.js"></script>
				...
				<div class="table-detail">
					...
					<table class="component-detail-table type-line-none">
						...
						<tr>
							...
							<td><input type="text" id="P_BIZRNO" name="P_BIZRNO" class="component-input type-full" maxlength="10" numeric></td>
							<th>진행상태</th>
							<td></td>							
						...
						<tr>
							...
							<td colspan="3">
								<input type="text" class="component-input type-full" id="P_VEND_NM" name="P_VEND_NM" >
							</td>
						</tr>
						<tr>
							<th><i class="icon-necessary"></i>버전</th>
							<td><comTag:comCmcdCdValueComboBox id="P_VERSION_NO" name="P_VERSION_NO" selectKey="${param.P_VERSION_NO}" cdId="VERSION_NO"  headerKey="" headerValue="선택" className="component-select"/></td>
							<th>
								<i class="icon-necessary"></i>발급구분
							</th>
							<td>
								<comTag:comCmcdCdValueComboBox id="P_LICENSE_PROCD_SECD" name="P_LICENSE_PROCD_SECD" selectKey="${param.P_LICENSE_PROCD_SECD}" cdId="LICENSE_PROCD_SECD"  headerKey="" headerValue="선택" className="component-select"/>
							</td>
						</tr>
						<tr>
							<th>
							...
							<td colspan="3">
								...
								<div class="component-calen">
									<div class="data-calen">
										<input type="text" id="P_LICENSE_ST_DATE" name="P_LICENSE_ST_DATE" class="component-input" date>
									</div>
									<em class="txt-bar">~</em>
									<div class="data-calen">
										<input type="text" id="P_LICENSE_END_DATE" name="P_LICENSE_END_DATE" class="component-input" date>
									</div>
								</div>
								<!-- //Component Calen -->
							</td>
						...
						<tr style="height: 50px;">
							...
							<td colspan="3">
								<input type="text" class="component-input type-full" id="P_VEND_IP_ADDR" name="P_VEND_IP_ADDR" >
							</td>
						</tr>
						</tbody>
					</table>
