...
<script type="text/javascript" src="${jsPath}/ipro/views/info/infoApprlineRegForm.js"></script> 
...
<div class="area-detail">
	<form id="dataFrm" class="search_form" method="POST" action="${contextPath}/info/infoApprlineRegist.do">
