...
<script type="text/javascript" src="${jsPath}/opro/views/ebid/allVltrnPrvstlList.js"></script> 
							...
							<tr>
								...
								<td>
									<div class="calendar_box">
		              					<input type="text" class="datepicker1" id="P_REQEST_DE_BEGIN_S" name="P_REQEST_DE_BEGIN_S" >
										<span class="wave">~</span>
		              					<input type="text" class="datepicker2" id="P_REQEST_DE_END_S" name="P_REQEST_DE_END_S"  >
									</div> <!--// calendar_box E -->
								</td>
			...
			<div class="list_wrap mt30">
				...
				<table class="tableList" summary="나의 입찰공고 목록입니다.">
		               ...
		               <colgroup>
						...
						<tbody>  
							<tr class="pointer" onclick="fnProgrsDetailView('A');" style="cursor: pointer;">
								<td class="txtc">
									1
								</td>
								<td class="txtc">
							...
							<tr class="pointer" onclick="fnProgrsDetailView('B');" style="cursor: pointer;">
								<td class="txtc">
									2
								</td>
								<td class="txtc">
				...
				<div class="list_bottom">
					<div class="list_pager">
						<comTag:paging totalCount="${vltrnPrvstlListTotcnt}" pageNo="${comFn:nvl(param.P_PAGE_NO, 1)}" pageSize="${comFn:nvl(param.P_PAGE_SIZE, 10)}" clickPage="pageObj.clickPage"/>
					</div> <!--// list_pager E -->
				</div> <!--// list_bottom E -->
			</div> <!--// list_wrap E -->
		</fieldset>	
...
<form id="detailFrm">
	<input type="hidden" name="resourceName" value="${param.resourceName}">
	<input type="hidden" name="P_GBN" id="P_GBN">
</form>            
