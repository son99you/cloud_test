 ...
 * <pre>
 * ebid 
 *    |_ inProgrsCnsBidPblancDetail.jsp
 *  
 * </pre>
 * @date : 2017. 06.19
 * @version : 1.0
...
<script type="text/javascript" src="${jsPath}/opro/views/ebid/inProgrsCnsBidPblancDetail.js"></script> 
  

<div id="panelSubContent">
	<h3 class="subTitle">진행중인 입찰공고 상세</h3>
