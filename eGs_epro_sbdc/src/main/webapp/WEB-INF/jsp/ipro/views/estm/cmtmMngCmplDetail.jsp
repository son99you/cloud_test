...
<script type="text/javascript" src="${jsPath}/ipro/views/estm/cmtmMngCmplDetail.js"></script>
...
<div class="area-detail">
	<form id="detailFrm" name="detailFrm" method="POST">
		...
		<c:if test="${estmMngMstDetail.ESTM_PSCD eq 'C001' }">
			<a href="javascript:" class="btn-bottom type-b" id="estmEndCnclBtn">평가종료취소</a>
		</c:if>
...
<form id="fileViewFrm" method="POST">
	<input type="hidden" id="P_FILE_GRP_NO" name="P_FILE_GRP_NO" value="${estmFile.FILE_GRP_NO}">
</form>
