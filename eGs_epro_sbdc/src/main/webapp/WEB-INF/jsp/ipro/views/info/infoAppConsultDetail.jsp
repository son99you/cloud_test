...
<script type="text/javascript" src="${jsPath}/ipro/views/info/infoAppConsultDetail.js"></script> 
...
<div class="area-detail">
	<form id="detailFrm" name="detailFrm" method="POST">
		...
		<input type="hidden" id="P_APPR_NO" name="P_APPR_NO" value="${tMmApplDetail.APPR_NO}">
		<input type="hidden" id="P_APRP_SN" name="P_APRP_SN" value="${tMmApplDetail.APRP_SN}">
		...
		<div class="table-detail">
			...
			<table class="component-detail-table type-line-none">
				...
				<tbody>
					<tr>
			        	<th>결재명</th>
			            <td colspan="3">${tMmApplDetail.APPR_NM }</td>
			         </tr>
			         <tr>   
			         	<th>요청자</th>
			            <td>${tMmApplDetail.REGR_NM }</td>
			        	<th>요청일시</th>
			            <td>${comFn:formatDate(tMmApplDetail.REG_DT, 'yyyyMMddhhmmss', 'yyyy-MM-dd')}</td>
			        </tr> 
				</tbody>
			</table>
		</div>
			...
			<table class="component-detail-table ">
				...
				<thead>
				 ...
				 <tbody id="apprShowTbdy">
		        	<c:forEach items="${tApprTglList }" var="data" varStatus="status">
			        	<tr>
		...
		<div class="bottom-buttons">
			<c:if test="${tMmApplDetail.APPR_TRGET eq 'Y' }">
...
<form id="popupFrm" method="POST" action="${contextPath}/info/popup/infoApprRsnRegist.do">
	<input type="hidden" id="P_APPR_NO" name="P_APPR_NO" value="${tMmApplDetail.APPR_NO}">
	<input type="hidden" id="P_SEQ" name="P_SEQ" value="${tMmApplDetail.SEQ}">
	<input type="hidden" id="P_APPR_YN" name="P_APPR_YN">
	<input type="hidden" id="P_JOB_SE" name="P_JOB_SE" value="${tMmApplDetail.JOB_SE}">
</form>
...
<form id="apprFrm" method="POST">
	...
	<input type="hidden" id="P_APRP_SN" name="P_APRP_SN" value="${tMmApplDetail.APRP_SN}">
	<input type="hidden" id="P_APPR_YN" name="P_APPR_YN">
	<input type="hidden" id="P_APPR_KEY1" name="P_APPR_KEY1" value="${tMmApplDetail.APPR_KEY1}">
	<input type="hidden" id="P_APPR_KEY2" name="P_APPR_KEY2" value="${tMmApplDetail.APPR_KEY2}">
	<input type="hidden" id="P_APPR_KEY3" name="P_APPR_KEY3" value="${tMmApplDetail.APPR_KEY3}">
</form>