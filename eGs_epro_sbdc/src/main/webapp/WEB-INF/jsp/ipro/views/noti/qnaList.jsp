...
<script type="text/javascript" src="${jsPath}/ipro/views/noti/qnaList.js"></script>
		...
		<div class="area-list">
		   ...
		   <div class="table-option">
				...
				<div class="option-right">
					...
					<a href="javascript:excelDwd('searchFrm', '/noti/qnaListExcelDwld.do','${comFn:nvl(qnaListTotCnt, 0)}');" class="btn-download-s type-fleft">
          		...
          		<tbody>
					...
					<c:if test="${qnaListTotCnt > 0}">
						<c:forEach var="data" items="${qnaList}" varStatus="status" >
							<tr  onclick="detailInqire('${data.BBS_SN}');" style="cursor: pointer;">
