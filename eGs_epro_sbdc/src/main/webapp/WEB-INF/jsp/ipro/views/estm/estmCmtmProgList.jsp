...
<script type="text/javascript" src="${jsPath}/ipro/views/estm/estmCmtmProgList.js"></script> 
	...
	<div class="table-detail">
		...
		<div class="nav_sec">
			...
			<div class="option-left">
				<ul class="location">
					<li style="font-size: 30px; font-weight: 500;">평가진행현황_평가위원 목록</li>
				</ul>
			</div>
			...
			<div class="table-option">
				...
				<div class="option-right">
					...
					<a href="javascript:excelDwd('searchFrm'
							, '/estm/estmCmtmProgListExcelDwld.do'
							,'${comFn:nvl(estmCmtmProgListTotCnt, 0)}');" class="btn-download-s type-fleft">
						...
						<c:if test="${estmCmtmProgListTotCnt > 0}">
							<c:forEach var="data" items="${estmCmtmProgList}" varStatus="status">
								<tr onclick="detailInqire('${data.ESTM_NO }');">
									...
									<td class="txt-center"><span class="tag-status type-change">${data.ESTM_PSCD_NM}</span></td>
