...
<script type="text/javascript" src="${jsPath}/ipro/views/estm/estmCmplExbePayDetail.js"></script>
		...
		<div class="table-detail">
			...
			<div class="top-detail">
				...
				<div class="type-fright">
					<a href="javascript:" class="component-button-s type-add" name="rsdnNoDelBtn" id="rsdnNoDelBtn">개인정보삭제</a>
				</div>
			</div>
			<!-- //Top -->
						...
						<c:if test="${not empty cmtmExbePayList}">
							<c:forEach var="data" items="${cmtmExbePayList}" varStatus="status">
								<tr>
									...
									<td class="txt-center">
										<input type="text" numeric id="P_ASSESS_AMT${status.count}" name="P_ASSESS_AMT" class="component-input w100" value="${data.ASSESS_AMT}">
										<!-- 지급금액 -->
									</td>
									<td class="txt-center">
									...
									<td class="txt-center">
										...
										<input type="hidden" id="P_PAY_ORGAN${status.count }" name="P_PAY_ORGAN" class="component-input w100" value="${data.PAY_ORGAN}" readonly="readonly">
										<input type="text" id="P_PAY_ORGANSUM${status.count }" class="component-input w100" value="${data.PAY_ORGANSUM}" readonly="readonly">
										<!-- 집행부서코드 -->
									</td>
									<td class="txt-center">
...
<form id="PayFrm" method="POST"> 
	...
	<input type="hidden" name="P_ASSESS_AMT"><!-- 지급금액 -->
