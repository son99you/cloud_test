...
<script type="text/javascript" src="${jsPath}/ipro/views/noti/notiUpdtForm.js"></script>
	...
	<div class="table-detail">
		...
		<div class="nav_sec">
			...
			<div class="option-left">
				<ul class="location">
					<li style="font-size: 30px; font-weight: 500;">공지사항 수정</li>
				</ul>
			</div>
...
<div class="area-detail">
	...
	<form id="updtFrm" method="POST" enctype="multipart/form-data">
		...
		<input type="hidden" name="P_BBS_SECD" value="${notiDetail.BBS_SECD}">
		<input type="hidden" name="P_BBS_SN" value="${notiDetail.BBS_SN}">
		
		<input type="hidden" id="P_FILE_GROUP_FLAG" name="P_FILE_GROUP_FLAG" value="noti">
		<input type="hidden" id="P_FILE_GRP_NO" name="P_FILE_GRP_NO" value="${notiDetail.FILE_GRP_NO}">
		...
		<table class="component-detail-table type-line-none">
			...
			<tbody>
				<tr class="line">
					<th>제목</th>
					<td colspan="3"><input type="text" id="P_TTL_NM" name="P_TTL_NM" value="${notiDetail.TTL_NM }" class="component-input type-full" placeholder="제목"></td>
				</tr>
				<tr>
					<th>등록자</th>
