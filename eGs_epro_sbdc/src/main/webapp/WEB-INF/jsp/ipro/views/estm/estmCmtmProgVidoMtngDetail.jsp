...
<%--
 * 평가관리 > 평가진행현황_평가위원 상세 - 화상회의
 *
 * <pre>
 * estm
 *    |_ estmCmtmProgVidoMtngDetail.jsp
 * 
 * </pre>
 * @date : 2021. 03. 22.
 * @version : 1.0
...
<script type="text/javascript" src="${jsPath}/ipro/views/estm/estmCmtmProgVidoMtngDetail.js"></script>
...
<div class="area-detail">
	<form id="detailFrm" name="detailFrm" method="POST">
		...
		<input type="hidden" name="P_ESTM_PROCD_SEQ" value="${paam.P_ESTM_PROCD_SEQ}">
			...
			<table class="component-detail-table ">
				...
				<tbody>
					<c:if test="${empty estmVidoList}">
						<tr>
							<td colspan="6" class="txt-center">데이터가 존재하지 않습니다</td>
						</tr>
					</c:if>
							...
							<tr>
								...
								<td class="txt-center">
									<c:if test="${not empty data.VIDO_MTNG_PRST_SECD }">
										...
										<!-- <a type="button" href="sc-sbdc21://?ext_room_id=190-1-1&ext_user_id=CMTM-hanill22&ext_password=421b308514&nickname=송광섭" class='component-button-s type-a' >방입장</a> -->
									</c:if>
