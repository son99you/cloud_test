...
<script type="text/javascript" src="${jsPath}/ipro/views/comm/popup/estmCmtmMngPoolDetail.js"></script>
		...
		<div class="table-detail">
			...
			<table class="component-detail-table type-line-none">
				...
				<tbody>
					...
					<tr>
						<th>생년월일</th>
						<td>${comFn:formatDate(estmCmtmPoolMstDetail.BRDT,'yyyyMMdd','yyyy-MM-dd') }</td>
						<th>수기등록여부</th>
