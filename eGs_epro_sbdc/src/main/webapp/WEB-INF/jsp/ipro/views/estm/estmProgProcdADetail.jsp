...
<script type="text/javascript" src="${jsPath}/ipro/views/estm/estmProgProcdADetail.js"></script>
	...
	<form id="detailFrm" name="detailFrm" method="POST">
		...
		<div class="table-detail">
			...
			<table class="component-detail-table ">
				<colgroup>
					<col width="80px;"><!-- 순위,순번 -->
					<%-- <col width="80px;"> --%>
					<col width="250px;"><!-- 평가대상명 -->
					<c:if test="${estmMngMstDetail.ESTM_OBJ_SECD eq 'B'}">
						<col width="150px;"><!-- 상품명 -->
					</c:if>
					<col width="100px;"><!-- 평가대상 첨부파일 -->
