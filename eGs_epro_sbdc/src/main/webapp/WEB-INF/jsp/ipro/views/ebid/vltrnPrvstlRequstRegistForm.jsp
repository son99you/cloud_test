...
<div class="conts_wrap">
	<div class="inner">
		...
		<form id="registFrm" method="POST" enctype="multipart/form-data" >
			<input type="hidden" name="P_PRCURE_REQEST_NO" value="${selectTepnEsremaDetail.ESTMT_NO }">
			...
			<div class="view_wrap typeA">
	        	...
	        	<div class="view_area">
		            <table>
		                ...
		                <tbody>
		                	 <tr>
			                    <th class="bullet_orange" scope="row">의뢰공고명</th>
			                    <td colspan="3">
			                    		<label for="P_PRVSTL_NM" class="blind">의뢰명</label>
			                    		<input type="text" id="P_PRVSTL_NM" name="P_PRVSTL_NM" value="스마트폰 구매"></td>
			              	</tr>
			                <tr>
			                	<th>구매구분</th>
			                	<td>내자구매</td>
			                ...
			                <tr>
			                	...
			                	<td>
                			        <div class="selectLayer2 w_120">
					            		<comTag:comCmcdCdValueComboBox id="P_COMPNO_PRDPRC_SE_CD" name="P_COMPNO_PRDPRC_SE_CD"   selectKey="${bidPlanDetail.COMPNO_PRDPRC_SE_CD}" cdId="22079" headerKey="" headerValue="선택" />
			                		</div>
			                    </td>
			                </tr>
			               <tr>
		            ...
		            <table>
						...
						<tr class="line">
							...
							<td>
                    			...
                    			<input type="text"  id="P_PRVSTL_DT" name="P_PRVSTL_DT" date class="w170">
				            ...
				            <table class="tableList" summary="입찰품목정보 수정 입니다.">
				                ...
				                <tbody>
				                	<tr>
				                		...
				                		<td style="text-align: center;">A20180002</td>
				                		<td style="text-align: center;">스마트폰</td>
				                		<td>삼성 갤럭시노트9</td>
				                		<td style="text-align: center;">NOTE9</td>
