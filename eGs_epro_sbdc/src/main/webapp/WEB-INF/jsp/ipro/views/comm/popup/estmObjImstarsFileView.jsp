...
<script type="text/javascript" src="${jsPath}/ipro/views/comm/popup/estmObjImstarsFileView.js"></script>
...
<div class="layout-pop">
	<form id="detailFrm" class="detailFrm" method="POST">
		...
		<input type="hidden" id="P_GOODSNO" name="P_GOODSNO" value="${param.P_GOODSNO }">
