...
<script type="text/javascript" src="${jsPath}/ipro/views/estm/estmProgVidoMtngDetail.js"></script>
			...
			<table class="component-detail-table type-line-none">
				...
				<tbody>
					...
					<tr>
						...
						<th>평가대상구분</th>
						<td>${estmMngMstDetail.ESTM_OBJ_SECD_NM }
						</td>
					</tr>
				</tbody>
			</table>
					...
					<c:forEach var="data" items="${estmVidoList}" varStatus="status">
						<tr>
							...
							<td class="txt-center"><!-- 회의시작일시 -->
								${data.VIDO_ST_DT}
								<input type="hidden" class="component-input type-full" id="P_VIDO_ST_DT" value="${data.VIDO_ST_DT }">
							...
							<td class="txt-center"><!-- 회의종료일시 -->
								${data.VIDO_END_DT}
								<input type="hidden" class="component-input type-full" id="P_VIDO_END_DT" value="${data.VIDO_END_DT }">
...
<form id="popupFrm" method="POST"> 
	...
	<input type="hidden" name="P_VIDO_ST_DT">
	<input type="hidden" name="P_VIDO_END_DT">
	<input type="hidden" name="P_VIDO_MTNG_NM">
