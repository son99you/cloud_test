...
<script type="text/javascript" src="${jsPath}/ipro/views/ebid/qualEvlScoreDetail.js"></script>
		...
		<div class="conts_wrap">
			<table>
				...
				<tr>
					...
					<td class="txtc"><input type="text" style="width: 30%" value="5"></td>
					<td class="txtc"><input type="text" style="width: 30%" value="4"></td>
				</tr>
				<tr>
					...
					<td class="txtc"><input type="text" style="width: 30%" value="3"></td>
					<td class="txtc"><input type="text" style="width: 30%" value="2"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="txtc"><input type="text" style="width: 30%" value="9"></td>
					<td class="txtc"><input type="text" style="width: 30%" value="9"></td>
				</tr>
				<tr>
					...
					<td class="txtc"><input type="text" style="width: 30%" value="10"></td>
					<td class="txtc"><input type="text" style="width: 30%" value="8"></td>
				</tr>
				<tr>
		...
		<div class="conts_wrap">
			<table>
				...
				<tr>
		        	...
		        	<td>주식회사 은우소프트</td>
		        	<td class="txtc" ><textarea rows="4" cols="" style="width: 95%">소개자료와 발표가 깔끔함</textarea> </td>
				</tr>
				<tr>
		        	<td>LIZ시스템</td>
		        	<td class="txtc" ><textarea rows="4" cols="" style="width: 95%">자료가 부실하고 설명이 제대로 되지 않음</textarea> </td>
				</tr>
				<tr>
		        	<td rowspan="2">전략 및 방법론</td>
		        	<td>주식회사 은우소프트</td>
		        	<td class="txtc" ><textarea rows="4" cols="" style="width: 95%">전략과 방법이 뛰어남</textarea> </td>
				</tr>
				<tr>
		        	<td>LIZ시스템</td>
		        	<td class="txtc" ><textarea rows="4" cols="" style="width: 95%">전략과 방법이 평범함</textarea> </td>
				</tr>
				<tr>
		        	<td rowspan="2">기술 및 기능</td>
		        	<td>주식회사 은우소프트</td>
		        	<td class="txtc" ><textarea rows="4" cols="" style="width: 95%">최신 기술을 이용한 기능구현</textarea> </td>
				</tr>
				<tr>
		        	<td>LIZ시스템</td>
		        	<td class="txtc" ><textarea rows="4" cols="" style="width: 95%">기능구현</textarea> </td>
				</tr>
				<tr>
		        	<td rowspan="2">프로젝트 관리</td>
		        	<td>주식회사 은우소프트</td>
		        	<td class="txtc" ><textarea rows="4" cols="" style="width: 95%">철저한 프로젝트 관리</textarea> </td>
				</tr>
				<tr>
		        	<td>LIZ시스템</td>
		        	<td class="txtc" ><textarea rows="4" cols="" style="width: 95%">프리한 프로젝트 관리</textarea> </td>
				</tr>
				<tr>
		        	<td rowspan="2">특수제안</td>
		        	<td>주식회사 은우소프트</td>
		        	<td class="txtc" ><textarea rows="4" cols="" style="width: 95%">제안이 흥미로움</textarea> </td>
				</tr>
				<tr>
		        	<td>LIZ시스템</td>
		        	<td class="txtc" ><textarea rows="4" cols="" style="width: 95%">제안 없음</textarea> </td>
				</tr>
				<tr>
		        	<td rowspan="2">테스트점수</td>
		        	<td>주식회사 은우소프트</td>
		        	<td class="txtc" ><textarea rows="4" cols="" style="width: 95%">테스트 훌륭함</textarea> </td>
				</tr>
				<tr>
		        	<td>LIZ시스템</td>
		        	<td class="txtc" ><textarea rows="4" cols="" style="width: 95%">테스트</textarea> </td>
				</tr>
			</table>
		</div>
	</div>
