...
<script type="text/javascript" src="${jsPath}/ipro/views/noti/qnaDetail.js"></script>
	...
	<div class="table-detail">
		...
		<div class="nav_sec">
			...
			<div class="option-left">
				<ul class="location">
					<li style="font-size: 30px; font-weight: 500;">QNA 상세</li>
				</ul>
			</div>
...
<div class="area-detail">
	...
	<div class="bottom-buttons">
		<c:if test="${loginResult.AUTH_ID eq '1' }">
			<c:if test="${sessionScope.loginResult.USR_ID ne qnaDetail.REGR_ID && qnaDetail.REPLY_YN eq 'N' && qnaDetail.RE_SEQ eq 0}">
				<a href="javascript:" class="btn-bottom type-b" id="replyBtn">답글</a>
			</c:if>
			<c:if test="${sessionScope.loginResult.USR_ID eq qnaDetail.REGR_ID}">
				<a href="javascript:" class="btn-bottom type-b" id="modifyBtn">답글수정</a>
				<a href="javascript:"class="btn-bottom type-b" id="deleteBtn">답글삭제</a>
			</c:if>
