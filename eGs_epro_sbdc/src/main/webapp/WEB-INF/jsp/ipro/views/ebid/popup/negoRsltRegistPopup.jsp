...
<script type="text/javascript" src="${jsPath}/ipro/views/ebid/popup/negoRsltRegistPopup.js"></script> 
	...
	<div class="pop_container">
		<div class="view_wrap typeA">
				...
				<form id="registFrm" method="POST">
					...
					<table class="table">
				    	...
				    	<tr>
				        	<th>최종협상금액</th>
				            <td>
				            	<input class="w150" id="P_LT_NEGO_AMT" name="P_LT_NEGO_AMT" value="${comFn:formatMoney(negoRsltInfo.LT_NEGO_AMT)}" money>
				            </td>
				        </tr>
				    	<tr>
				        	<th>협상일시</th>
				            <td>
				            	<input type="text" id="P_NEGO_DT" name="P_NEGO_DT" class="w120" date value="${comFn:formatDate(negoRsltInfo.NEGO_DT,'yyyyMMddHHmmss','yyyy-MM-dd')}">
				            </td>
				        </tr>
				        <tr>
				            <th class="bullet_orange">협상결과<br/>첨부파일</th>
				            <td>
			...
			<div class="btn_wrap view_btn">
				<c:if test="${negoRsltInfo.BID_PSCD eq 'PF50'}">
