...
<script type="text/javascript" src="${jsPath}/ipro/views/comm/popup/deptList.js"></script>
		...
		<div class="form-setting-box">
	        <div class="ui-setting">
	            ...
	            <div class="form-setting">
	                <span class="txt-label">상위부서명</span>
	                <input type="text" id="P_HI_DEPT_NM_S" name="P_HI_DEPT_NM_S" value="${param.P_HI_DEPT_NM_S}"  class="component-input w50"/>
	            </div>
	            <!-- //Form Setting -->
	            
	        	<!-- Form Setting -->
	            <div class="form-setting">
	                <span class="txt-label">부서코드</span>
	                <input type="text" id="P_DEPT_NO_S" name="P_DEPT_NO_S" value="${param.P_DEPT_NO_S}"  class="component-input w50"/>
	            </div>
	            <!-- //Form Setting -->
	        </div>
	        <div class="ui-setting">
					...
					<c:if test="${deptInqireListTotcnt > 0}">
						<c:forEach var="data" items="${deptInqireList}" varStatus="status">
							...
							<tr class="txt-center"
								...
								<td class="txtl pl5"><input type="hidden" name="P_HI_DEPT_NM" value="${data.HI_DEPT_NM }"> ${data.HI_DEPT_NM}&nbsp;</td>
