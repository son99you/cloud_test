...
<script type="text/javascript" src="${jsPath}/ipro/views/ebid/bidPlanUpdtForm.js"></script>
					...
					<table>
						...
						<tbody>
					    	...
					    	<tr>	
					            ...
					            <td colspan="3">
									<input type="text" id="usrNm" name="P_CHRGR_NM" value="${bidPlanDetail.CHRGR_NM}" class="w180" readonly="readonly">
				        	...
				        	<tr>
					            ...
					            <td>
					            	<input type="text" id="usrTel" name="P_CHRGR_TEL_NO" value="${bidPlanDetail.CHRGR_TEL_NO }" class="w180" >
					            </td>
					            <th scope="row" class="bullet_orange">입찰문의 이메일</th>
					            <td>
					            	<input type="text" id="mail" name="P_CHRGR_EMAL" value="${bidPlanDetail.CHRGR_EMAL }" class="w180" >
					            </td>
				        	</tr>
					    	<tr>	
				        	...
				        	<tr>
					            ...
					            <td>
					            	<input type="text" id="tchnUsrTel" name="P_TCHN_CHRGR_TEL_NO" value="${bidPlanDetail.TCHN_CHRGR_TEL_NO }" class="w180">
					            </td>
					            <th scope="row" class="bullet_orange">기술문의 이메일</th>
					            <td>
					            	<input type="text" id="tchnMail" name="P_TCHN_CHRGR_EMAL" value="${bidPlanDetail.TCHN_CHRGR_EMAL }" class="w180">
					            </td>
				        	</tr>
						</tbody>						
					</table>
				...
				<div class="view_area">
					<table>
				        ...
				        <tr>
				            ...
				            <td colspan="3">
			            		<comTag:comCmcdCdValueComboBox id="P_CONT_MTCD" name="P_CONT_MTCD"   selectKey="${bidPlanDetail.CONT_MTCD}" cdId="CONT_MTCD" cond1="BID" headerKey="" headerValue="선택" width="160"/>
				            </td>
				        </tr>
				        <tr>
				        	<th scope="row" class="bullet_orange"><label for="P_SBID_MTCD">낙찰자선정방법</label></th>
				            <td>
			            		<comTag:comCmcdCdValueComboBox id="P_SBID_MTCD" name="P_SBID_MTCD"   selectKey="${bidPlanDetail.SBID_MTCD}" cdId="SBID_MTCD" cond1="BID" headerKey="" headerValue="선택" width="160"/>
				            </td>
		            ...
		            <table>
		                ...
		                <tbody>
			                ...
			                <tr>
			                    ...
			                    <td>
			                        <input type="text" class="tr PT2" id="P_DFFL_GTAMT_RT" name="P_DFFL_GTAMT_RT" value="<c:if test="${empty bidPlanDetail.ANNC_NO}">2</c:if><c:if test="${not empty bidPlanDetail.ANNC_NO}">${bidPlanDetail.DFFL_GTAMT_RT}</c:if>" numeric maxlength="4">
			                    </td>
			                    <%-- 계약구분이 [구매] 일 경우 활성화 --%>
				...
				<div class="view_area grlDiv">
		            <table>
		                ...
		                <tr class="brfsDiv" <c:if test="${bidPlanDetail.BID_BRFS_YN ne 'Y'}"> style="display:none;"</c:if>>
		                    <th scope="row" class="bullet_orange" id="brfsTh"><label for="P_BRFS_DT">입찰설명회일시</label></th>
		                    <td>
		                ...
		                <tr class="hndwDiv" <c:if test="${bidPlanDetail.ANNC_SECD ne 'HNDW_BID' }">style="display: none;"</c:if>>
		                    <th scope="row" class="bullet_orange"><label for="P_OPNG_PLC_NM">개찰장소</label></th>
		                    <td>
		                    	<input type="text" id="P_OPNG_PLC_NM" name="P_OPNG_PLC_NM" value="${bidPlanDetail.OPNG_PLC_NM }" >
		                    </td>
						</tr>
		                </tbody>
		            </table>
...
<form id="listFrm" method="POST">
  	<input type="hidden" name="resourceName" value="${param.resourceName}">
  	<input type="hidden" name="P_PAGE_NO" value="1">
	<input type="hidden" name="P_PAGE_SIZE" value="10">
</form>
...
<form id="fileViewFrm" method="POST">
	<input type="hidden" id="P_FILE_GRP_NO_EXT" name="P_FILE_GRP_NO_EXT" value="${bidPlanDetail.FILE_GRP_NO}">
</form>