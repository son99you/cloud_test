...
<%--
 * 공통 > 상품관리 - 상품정보 아임스타즈 연계 상세 팝업 : 상세내용
 *
 * <pre>
 * comm 
 *   |_ popup
...
<script type="text/javascript" src="${jsPath}/ipro/views/comm/popup/estmObjImstarsPrdsView.js"></script>
