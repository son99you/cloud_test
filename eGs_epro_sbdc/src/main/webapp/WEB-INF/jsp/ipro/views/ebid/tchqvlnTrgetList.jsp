...
<script type="text/javascript" src="${jsPath}/ipro/views/ebid/tchqvlnTrgetList.js"></script> 
								...
								<td>
									<table>
										...
										<tr height="24px">
											...
											<td>
												<select name="P_EVL_PRST_CD" id="P_EVL_PRST_CD">
													<option value="">전체</option>
													<option value="PL10">평가실시전</option>
													<option value="PL20">평가중</option>
													<option value="PL21">정량평가완료</option>
													<option value="PL30">평가완료</option>
													<option value="PL90">평가결과결재상신</option>
													<option value="PL91">평가결과결재중</option>
													<option value="PL92">평가결과결재반려</option>
													<option value="PL93">평가결과결재회수</option>
													<option value="PL94">평가결과결재완료</option>
												</select>
											</td>
											<td>
		...
		<div class="list_wrap mt30" id="contentWrap">
			...
			<div class="list_conts">		
				<table>
			        ...
			        <tr class="pointer" onclick="tchqvlnResultRegistForm('PL20');">
			        ...
			        <tr class="pointer" onclick="tchqvlnResultRegistForm('PL30');">
