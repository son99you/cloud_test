...
<script type="text/javascript" src="${jsPath}/ipro/views/estm/cmtmMngProgUpdtForm.js"></script>
	...
	<div class="table-detail">
		...
		<div class="nav_sec">
			...
			<div class="option-left">
				<ul class="location">
					<li style="font-size: 30px; font-weight: 500;">평가위원평가진행현황 수정</li>
				</ul>
			</div>
...
<div class="area-detail">
	<form id="updtFrm" name="updtFrm" method="POST" enctype="multipart/form-data">
		...
		<input type="hidden" id="P_RETURN_URL" name="P_RETURN_URL" value="/estm/cmtmMngProgDetail.do">
			...
			<table class="component-detail-table type-line-none">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<comTag:comCmcdCdValueComboBox id="P_ESTM_SECD" name="P_ESTM_SECD" cdId="ESTM_SECD" selectKey="${estmMngMstDetail.ESTM_SECD }" cond1="CMTM_PROG" headerValue="전체" className="component-select"/>
						</td>
						<th>평가정보연계번호</th>
					...
					<c:forEach var="data" items="${estmProcdList}" varStatus="status">
						...
						<td>
							<div class="area-calen">
								...
								<!-- Component Time -->
								<div class="component-time">
									<input type="text" name="P_ESTM_PROCD_ST_HH" value="${comFn:formatDate(data.ESTM_PROCD_ST_DT,'yyyyMMddHHmmss', 'HH')}" class="component-input" numeric maxlength="2" onblur="fnTimeHHChk(this)">
									<em class="time-bar">:</em>
									<input type="text" name="P_ESTM_PROCD_ST_MM" value="${comFn:formatDate(data.ESTM_PROCD_ST_DT,'yyyyMMddHHmmss', 'mm')}" class="component-input" numeric maxlength="2" onblur="fnTimeMMChk(this)">
								</div>
								<!-- //Component Time -->
							</div>
						</td>
						<td>
							<div class="area-calen">
								...
								<!-- Component Time -->
								<div class="component-time">
									<input type="text" name="P_ESTM_PROCD_END_HH" value="${comFn:formatDate(data.ESTM_PROCD_END_DT,'yyyyMMddHHmmss', 'HH')}" class="component-input" numeric maxlength="2" onblur="fnTimeHHChk(this)">
									<em class="time-bar">:</em>
									<input type="text" name="P_ESTM_PROCD_END_MM" value="${comFn:formatDate(data.ESTM_PROCD_END_DT,'yyyyMMddHHmmss', 'mm')}" class="component-input" numeric maxlength="2" onblur="fnTimeMMChk(this)">
								</div>
								<!-- //Component Time -->
							</div>
						</td>
