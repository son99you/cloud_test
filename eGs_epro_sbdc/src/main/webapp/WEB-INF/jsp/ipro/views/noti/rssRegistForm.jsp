...
<script type="text/javascript" src="${jsPath}/ipro/views/noti/rssRegistForm.js"></script> 
	...
	<form id="registFrm" method="POST">
		...
		<div class="sp_cont">
			<table class="form_tb">
				...
				<tr class="line">
					<th>제목</th>
					<td colspan="3"><input type="text" id="P_TTL_NM" name="P_TTL_NM" value="" class="input "  placeholder="제목"></td>
				</tr>
				<tr>
					<th>등록자</th>
					<td>
				...
				<tr>
					<th>내용</th>
					<td colspan="3">
						<textarea id="P_BBS_CNTN" name="P_BBS_CNTN" style="width: 100%; height: 200px; padding:7px" placeholder="내용"></textarea>
					</td>
				</tr>
			</table>
