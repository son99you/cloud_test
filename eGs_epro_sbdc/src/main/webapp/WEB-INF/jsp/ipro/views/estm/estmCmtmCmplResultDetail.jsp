...
<%--
 * 평가관리 > 평가완료현황_평가위원 상세 - 평가결과
 *
 * <pre>
 * estm
 *    |_ estmCmtmCmplResultDetail.jsp
 * 
 * </pre>
 * @date : 2021. 03. 22.
 * @version : 1.0
...
<script type="text/javascript" src="${jsPath}/ipro/views/estm/estmCmtmCmplResultDetail.js"></script>
	...
	<div class="table-detail">
		...
		<div class="nav_sec">
			...
			<div class="option-left">
				<ul class="location">
					<li style="font-size: 30px; font-weight: 500;">평가완료현황_평가위원 상세</li>
				</ul>
			</div>
					...
					<c:if test="${data.ESTR_SECD eq 'A' }"><!-- 평가위원 평가만 보이도록 세팅 -->
						<c:if test="${ estmProcdDetail.ESTM_PROCD_SEQ eq data.ESTM_PROCD_SEQ }">
							<li class="is-selected">
								<a href="javascript:dynamicCmtmEstmTabEvent('${data.ESTM_PROCD_SEQ }','${data.ESTR_SECD }','detailFrm','${data.ESTM_PROCD_PSCD }','cmpl');">${data.ESTM_PROCD_NM }</a>
							</li>
						</c:if>
		...
		<div class="table-detail">
			...
			<div class="table-option">
				...
				<div class="option-right">
					...
					<a href="javascript:excelDwd('detailFrm', '/estm/estmProgResultDetailExcelDwld.do','${comFn:nvl(estmResultObjAllListTotCnt, 0)}');" class="btn-download-s type-fleft">
