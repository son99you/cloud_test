...
<script type="text/javascript" src="${jsPath}/ipro/views/noti/faqUpdtForm.js"></script>
	...
	<div class="table-detail">
		...
		<div class="nav_sec">
			...
			<div class="option-left">
				<ul class="location">
					<li style="font-size: 30px; font-weight: 500;">FAQ 수정</li>
				</ul>
			</div>
...
<div class="area-detail">
	...
	<table class="component-detail-table type-line-none">
			<colgroup>
				...
				<tr class="line">
					<th>제목</th>
					<td colspan="3"><input type="text" id="P_TTL_NM" name="P_TTL_NM" value="${faqDetail.TTL_NM }" class="component-input type-full"  placeholder="제목"></td>
				</tr>
				<tr>
					<th>등록자</th>
...
<form id="fileViewFrm" method="POST">
	<input type="hidden" id="P_FILE_GRP_NO_EXT" name="P_FILE_GRP_NO_EXT" value="${faqDetail.FILE_GRP_NO}">
</form>