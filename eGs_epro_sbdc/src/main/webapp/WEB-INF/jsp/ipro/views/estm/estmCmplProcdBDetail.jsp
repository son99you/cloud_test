...
<script type="text/javascript" src="${jsPath}/ipro/views/estm/estmCmplProcdBDetail.js"></script>
			...
			<table class="component-detail-table ">
				...
				<tbody>
					...
					<tr>
						...
						<%-- <td class="txt-center">${data.ESTM_TOT_SCR }</td><!--  총점  --> --%>
					</tr>
					</c:forEach>
				</tbody>
			</table>
