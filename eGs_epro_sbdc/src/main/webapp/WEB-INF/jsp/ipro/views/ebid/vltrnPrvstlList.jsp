				...
				<div class="btn_wrap mt10">
					...
					<div class="list_conts" style="width: auto; height: auto; overflow-x: scroll; overflow-y: hidden;">
						<table style="width: 1500px;">
							...
							<tbody>
									<tr class="row" onclick="fnDetailView('','');" style="cursor: pointer;">
										<td>1&nbsp;</td>
										<td>작성중&nbsp;</td>
										<td>구매&nbsp;</td>
										<td>E2018-00002&nbsp;</td>
										...
										<td>일반경쟁&nbsp;</td>
										<td>계약관리팀</td>
										<td><div class="btn_before">사용자2</div></td>
										<td>2018-05-17&nbsp;</td>
										<td>2018-05-17&nbsp;</td>
										<td>2018-05-17&nbsp;</td>
										<td><div class="btn_before">사용자2</div></td>
									</tr>
									<tr class="row" onclick="fnRegistForm('');" style="cursor: pointer;">
										<td>2&nbsp;</td>
										<td>등록대기&nbsp;</td>
										<td>구매&nbsp;</td>
										<td>PO2018-00001&nbsp;</td>
