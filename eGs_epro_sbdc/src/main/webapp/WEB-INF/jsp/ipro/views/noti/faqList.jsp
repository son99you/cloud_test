...
<script type="text/javascript" src="${jsPath}/ipro/views/noti/faqList.js"></script>
	...
	<div class="table-detail">
		...
		<div class="nav_sec">
			...
			<div class="option-left">
				<ul class="location">
					<li style="font-size: 30px; font-weight: 500;">FAQ 목록</li>
				</ul>
			</div>
		...
		<div class="table-option">
			...
			<div class="option-right">
				...
				<div class="table-num type-fleft">
					총 <strong>${comFn:nvl(faqListTotCnt, 0)}</strong>건
				</div>
				<a href="javascript:excelDwd('searchFrm', '/noti/faqListExcelDwld.do','${comFn:nvl(faqListTotCnt, 0)}');" class="btn-download-s type-fleft">
	...
	<table class="component-table">
		   <colgroup>
         	...
         	<tbody>
				...
				<!-- //엑셀다운로드데이터 종료 -->
	         	  <c:if test="${comFn:nvl(faqListTotCnt, 0) == 0}">
					<tr>
	   ...
	   <div class="component-pageing">
		   <comTag:pagingIpro totalCount="${comFn:nvl(faqListTotCnt,0)}" pageNo="${comFn:nvl(param.P_PAGE_NO, 1)}" pageSize="${comFn:nvl(param.P_PAGE_SIZE, 10)}" clickPage="pageObj.clickPage"/>
	  </div>
	  <!--  //pageing -->
