...
<script type="text/javascript" src="${jsPath}/ipro/views/sytm/contFormModiForm.js"></script>
...
<div class="sp_sec">
	...
	<form id="modiFrm" method="POST" enctype="multipart/form-data">
		...
		<input type="hidden" name="P_ADD_FILE_GRP_NO" value="${contFormDetail.FILE_GRP_NO}">
		...
		<div class="sp_cont">
			...
			<table class="form_tb">
				...
				<tr>
					<th>서식명</th>
					<td colspan="3">
						<input type="text"  id="P_FRM_NM" name="P_FRM_NM"   value="${contFormDetail.FRM_NM}" class="input w100p" placeholder="서식명" />
					</td>
				</tr>
					<tr>
						<th>계약구분</th>
					...
					<!-- <tr>
						<th>내용</th>
						<td colspan="3">
							<textarea id="P_FRM_CNTN" name="P_FRM_CNTN" style="width: 100%; height: 200px;"></textarea>
						</td>
					</tr> --> 
					...
					<tr>
						...
						<td class="vtop"> 
							<div style="float:left"> 
								<input type="hidden" name="P_FILE_SN" value="${contFormDetail.CTDC_FILE_SN}" disabled="disabled" />
								<input type="hidden" name="P_CTDC_FILE_GRP_NO" value="${contFormDetail.CTDC_FILE_GRP_NO}" />
