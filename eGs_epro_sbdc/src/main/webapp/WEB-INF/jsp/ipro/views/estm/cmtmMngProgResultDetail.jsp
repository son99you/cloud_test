...
<%--
 * 평가관리 > 평가위원관리 > 평가위원평가진행현황 상세 - 평가결과
 *
 * <pre>
 * estm
 *    |_ cmtmMngProgResultDetail.jsp
 * 
 * </pre>
 * @date : 2021. 03. 22.
 * @version : 1.0
...
<script type="text/javascript" src="${jsPath}/ipro/views/estm/cmtmMngProgResultDetail.js"></script>
				...
				<div class="table-detail" id="filter_schDiv" style="display: ;"><!-- display: none; -->
					<table class="component-detail-table ">
						...
						<tbody>
							...
							<c:forEach var="data" items="${estmTabList}" varStatus="status">
							<!-- 
								평가서식구분이 적격(C)인 경우 평가총점이 나오지 않도록 구현
							-->
								<td>
