...
<script type="text/javascript" src="${jsPath}/ipro/views/estm/estmProgRegistForm.js"></script>
	...
	<div class="table-detail">
		...
		<div class="nav_sec">
			...
			<div class="option-left">
				<ul class="location">
					<li style="font-size: 30px; font-weight: 500;">평가진행현황 등록</li>
				</ul>
			</div>
			...
			<table class="component-detail-table type-line-none">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<%-- <comTag:comCmcdCdValueComboBox id="P_ESTM_SECD" name="P_ESTM_SECD" cdId="ESTM_SECD" cond1="ESTM_PROG" headerValue="전체" className="component-select"/> --%>
					...
					<tr>
						...
						<td>
							<comTag:comCmcdCdValueComboBox id="P_OUT_CMTM_SLCT_MTHD_SECD" name="P_OUT_CMTM_SLCT_MTHD_SECD" cdId="ESTM_CMTM_SLCT_MTHD" headerValue="전체" className="component-select"/>
						</td>
					...
					<tr>
						<th>외부평가위원수</th>
						<td><input type="text" id="P_OUT_ESTM_CMTM_CNT" name="P_OUT_ESTM_CMTM_CNT" class="component-input w20" numeric maxlength="2"> 명</td>
						<th>내부평가위원수</th>
						<td><input type="text" id="P_INN_ESTM_CMTM_CNT" name="P_INN_ESTM_CMTM_CNT" class="component-input w20" numeric maxlength="2"> 명</td>
					</tr>
					<tr>
						<th>외부평가위원배수</th>
						<td><input type="text" id="P_OUT_ESTM_CMTM_TMES" name="P_OUT_ESTM_CMTM_TMES" class="component-input w20" numeric maxlength="2"> 배수</td>
						<th>내부평가위원배수</th>
						<td><input type="text" id="P_INN_ESTM_CMTM_TMES" name="P_INN_ESTM_CMTM_TMES" class="component-input w20" numeric maxlength="2"> 배수</td>
					</tr>
					<tr>
						<th>지정평가위원수</th>
						<td><input type="text" id="P_FIX_ESTM_CMTM_CNT" name="P_FIX_ESTM_CMTM_CNT" class="component-input w20" numeric maxlength="2"> 명</td>
						<th></th>
						<td></td>
					</tr>
					<tr>
