...
<script type="text/javascript" src="${jsPath}/ipro/views/sytm/estmSpheMngRegistForm.js"></script>
	...
	<div class="table-detail">
		...
		<div class="nav_sec">
			...
			<div class="option-left">
				<ul class="location">
					<li style="font-size: 30px; font-weight: 500;">평가분야관리 등록</li>
				</ul>
			</div>
			...
			<table class="component-detail-table type-line-none">
				...
				<tbody>
					<tr>
						...
						<td><input type="text" id="P_ESTM_SPHE_SENM" name="P_ESTM_SPHE_SENM" class="component-input w100"></td>
					</tr>
				</tbody>
			</table>
		</div>
...
<form id="detailFrm" method="POST">
	...
	<%-- <input type="hidden" name="P_ESTM_SPHE_SECD" value="${param.P_ESTM_SPHE_SECD }"> --%>
