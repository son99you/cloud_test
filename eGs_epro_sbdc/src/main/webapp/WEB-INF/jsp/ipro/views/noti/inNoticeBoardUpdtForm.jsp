...
<script type="text/javascript" src="${jsPath}/ipro/views/noti/inNoticeBoardUpdtForm.js"></script> 
...
<div class="content">
	<form id="updtFrm" method="POST" enctype="multipart/form-data" >
		...
		<input type="hidden" id="P_PAGE_SIZE" name="P_PAGE_SIZE" value="10">
       	<input type="hidden" id="P_NTT_SN" name="P_NTT_SN"  value="${inNoticeBoardDetail.NTT_SN}">
 
		<input type="hidden" id="P_DELETE_FILE_SN" name="P_DELETE_FILE_SN" value=""> 
		<input type="hidden" id="P_ATCHMNFL_GROUP_NO" name="P_ATCHMNFL_GROUP_NO" value="${inNoticeBoardDetail.ATCHMNFL_GROUP_NO}">
			        ...
			        <div class="view_area">
						<table>
				    		...
				    		<tr class="line">
			                   <th>제목</th>
			                   <td colspan="3">
			                    	<input type="text" id="P_SJ_NM" name="P_SJ_NM"  maxlength="200"  class="w_95p"  value="${inNoticeBoardDetail.SJ_NM}">
			                </td>
			               </tr>
				        	<tr>
					            <th>등록자</th> 
					            <td>     
					            	<input type="text"  id="P_USER_NM" name="P_USER_NM" value="${inNoticeBoardDetail.REGISTER_NM}" maxlength="10" readonly  class="w_95p disabled" >
				               	</td>
					            <th>이메일</th>
					            <td>
				       				<input type="text"  id="P_EMAIL"  name="P_EMAIL"  value="${inNoticeBoardDetail.EMAIL_ADRES}" style="width: 88%;" readonly class="w_95p disabled" >
					            </td>  
					        </tr>
			               <tr>
			                    <th>내용</th> 
