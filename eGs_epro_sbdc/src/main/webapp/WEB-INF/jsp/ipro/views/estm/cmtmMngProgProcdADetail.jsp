...
<%--
 * 평가관리 > 평가위원관리 > 평가위원평가진행현황 상세 - 서류평가, 품평회
 *
 * <pre>
 * estm
 *    |_ cmtmMngProgProcdADetail.jsp
 * 
 * </pre>
 * @date : 2021. 03. 22.
 * @version : 1.0
...
<script type="text/javascript" src="${jsPath}/ipro/views/estm/cmtmMngProgProcdADetail.js"></script>
