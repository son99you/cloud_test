...
<script type="text/javascript" src="${jsPath}/ipro/views/estm/estmCmtmSpheMpgRegForm.js"></script>
							...
							<div class="left-box">
								...
								<div class="right-box">
									...
									<div class="box-move-list type-fright" style="height:510px;">
										<table class="component-table" style="table-layout:auto;"><!-- style="table-layout:auto;" -->
											<colgroup>
												<col width="10%;">
												<col width="auto;">
												<col width="auto;">
