<%@page import="com.raonwiz.keditor.RAONKHandler"%><%@page import="com.raonwiz.keditor.event.*"%><%@page import="com.raonwiz.keditor.util.EventVo"%><%@page import="com.raonwiz.keditor.common.ImageApi"%><%@ page contentType="text/html;charset=utf-8"%><%
	...
	editor.settingVo.setAllowFileExtension("gif, jpg, jpeg, png, bmp, wmv, asf, swf, avi, mpg, mpeg, mp4, txt, doc, docx, xls, xlsx, ppt, pptx, hwp, zip, pdf, flv, webm, ogv, webm");
	...
	*/
	...
	event.addAfterUploadEventListener(new AfterUploadEventListener() {
		public void afterUploadEvent(EventVo eventVo) {
        	...
        	String strResponseFileServerPath = eventVo.setResponseFileServerPath();
	...
	*/
	...
	editor.settingVo.setPhysicalPath("D:/eGovFrameDev-3.6.0-64bit/workspace/eCdocuDev/src/main/webapp/WEB-INF/jsp/raonkeditor/uploadimg");
