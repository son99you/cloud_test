...
<script type="text/javascript" src="${jsPath}/opro/views/estm/estmCmtmCmplList.js"></script> 
		...
		<div class="area-list">
			...
			<div class="table-option">
				...
				<div class="option-right">
					...
					<a href="javascript:excelDwd('searchFrm', '/opro/estm/estmCmtmCmplListExcelDwld.do','${comFn:nvl(estmCmtmCmplListTotCnt, 0)}');" class="btn-download-s type-fleft">
