...
<script type="text/javascript" src="${jsPath}/opro/views/noti/faqList.js"></script>
		...
		<!-- //buttons -->
	 	 ...
	 	 <!-- Option -->
			<div class="table-option">
				...
				<a href="javascript:excelDwd('searchFrm', '/opro/noti/faqListExcelDwld.do','${comFn:nvl(notiGnrlListTotCnt, 0)}');" class="btn-download-s type-fleft">
