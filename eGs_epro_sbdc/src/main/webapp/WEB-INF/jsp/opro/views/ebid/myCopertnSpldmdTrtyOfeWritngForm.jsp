...
<%--
 * 입찰관리 > 나의 입찰관리 상세 > 나의 공동수급 협정서 제출 폼
 *
 * <pre>
 * ebid
 *    |_ myCopertnSpldmdTrtyOfeWritngForm.jsp
 * 
...
<script type="text/javascript" src="${jsPath}/opro/views/ebid/myCopertnSpldmdTrtyOfeWritngForm.js"></script> 
