...
<script type="text/javascript" src="${jsPath}/opro/views/ebid/myBidPblancDetail.js"></script> 
		...
		<div class="view_area">
			<table>
		        ...
		        <tr>
		            ...
		            <td>
		            	${inProgrsBidPblancDetail.PRPDC_ESS_YN_NM}
		            </td>
	            ...
	            <table style="width:100%;">
	                ...
	                <tbody>
						<tr class="row" id="biprInfoEmpty" <c:if test="${ not empty bidPrdlsList}"> style="display:none;"</c:if>>
		               		<td colspan="8" style="text-align: center;">입찰품목이 없습니다.</td>
		               	</tr>
	               	</tbody>
	            </table>
	        </div>
...
<form id="listFrm" method="POST" action="${contextPath}/elbi/bidPblancList.do">
