...
<script type="text/javascript" src="${jsPath}/opro/views/noti/qnaRegistForm.js"></script> 
	...
	<div class="table-detail">
		...
		<div class="nav_sec">
			...
			<div class="option-left">
				<ul class="location">
					<li style="font-size: 30px; font-weight: 500;">QNA 등록</li>
				</ul>
			</div>
	...
	<form id="registFrm" method="POST">
		...
		<input type="hidden" name="P_BBS_SN">
			<table class="component-detail-table type-line-none">
				...
				<tr class="line">
					<th>제목</th>
					<td colspan="3"><input type="text" id="P_TTL_NM" name="P_TTL_NM" class="component-input type-full" placeholder="제목"></td>
				</tr>
				<tr>
					<th>등록자</th>
					<td>${sessionScope.loginResult.USR_NM}</td>
					<th>이메일</th>
					<%-- <td>${sessionScope.loginResult..EMAL_ADDR }</td> --%>
