 ...
 * <pre>
 * estm
 *    |_ estmCmtmProgProcdBDetail.jsp
 * 
 * </pre>
 * @date : 2021. 03. 22.
 * @version : 1.0
...
<script type="text/javascript" src="${jsPath}/opro/views/estm/estmCmtmProgProcdBDetail.js"></script>
				...
				<tbody>
					...
					<tr>
						...
						<c:if test="${ cmtmAt eq 'F' }">
							<td class="txt-center" onclick="detailInqirePopup('${data.ESTM_OBJ_SEQ}','cmtmAtFalse','B');" style="cursor: pointer;">0</td>
						</c:if>
						<!-- //세션로그인 한 사람이 평가위원중 한명인지 체크하여 아니면 일괄적으로 0으로 세팅하고 평가팝업에서 저장을 할 수 없도록 구현하기 -->
