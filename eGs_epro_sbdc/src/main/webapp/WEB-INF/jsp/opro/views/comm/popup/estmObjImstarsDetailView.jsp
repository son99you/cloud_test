...
<script type="text/javascript" src="${jsPath}/opro/views/comm/popup/estmObjImstarsDetailView.js"></script>
						...
						<td colspan="3">
							<c:if test="${not empty goodsDetail.REPRSNTIMAGEFILEID}">
								<a href="javascript:imstarsDetailDownload('${goodsDetail.REPRSNTIMAGEFILEID}');">
									<img border="0" src ="/opro/comm/imstarsDetailDownload.do?P_FILE_ID=${goodsDetail.REPRSNTIMAGEFILEID}">
								</a>
							</c:if>
						</td>
					</tr>
