...
<script type="text/javascript" src="${jsPath}/opro/views/noti/qnaUpdtForm.js"></script>
	...
	<div class="table-detail">
		...
		<div class="nav_sec">
			...
			<div class="option-left">
				<ul class="location">
					<li style="font-size: 30px; font-weight: 500;">QNA 수정</li>
				</ul>
			</div>
...
<div class="area-detail">
	...
	<form id="updtFrm" method="POST" enctype="multipart/form-data">
		...
		<input type="hidden" name="P_BBS_SN" value="${qnaDetail.BBS_SN}"><!-- 24  저장을 눌렀지만 1로 가는 경우 , 데이터확인하기 , 호출확인하기  -->
			...
			<colgroup>
				...
				<tr>
					...
					<td>${qnaDetail.REGR_NM }</td>
						<th>이메일</th>
					<td>${sessionScope.loginResult.EMAL}</td>
				</tr>
				<tr>
					<th>내용</th>
...
<%-- <form id="fileViewFrm" method="POST">
	<input type="hidden" id="P_FILE_GRP_NO_EXT" name="P_FILE_GRP_NO_EXT" value="${qnaDetail.FILE_GRP_NO}">
</form> --%>