...
<script type="text/javascript" src="${jsPath}/opro/views/noti/rssList.js"></script>
	...
	<form id="searchFrm" name="searchFrm" method="post">
		...
		<fieldset>
			...
			<div class="list_wrap mt30" id="contentWrap">
				<div class="list_top">
					<p class="total">총 <span>${comFn:nvl(notiGnrlListTotCnt, 0)}</span>건</p>		
				</div> <!--// list_top E -->
				...
				<div class="list_bottom">
					<comTag:pagingIpro totalCount="${notiGnrlListTotCnt}" pageNo="${comFn:nvl(param.P_PAGE_NO, 1)}" pageSize="${comFn:nvl(param.P_PAGE_SIZE, 10)}" clickPage="pageObj.clickPage"/>
				</div> <!--// list_bottom E -->			
		    </div> 				
