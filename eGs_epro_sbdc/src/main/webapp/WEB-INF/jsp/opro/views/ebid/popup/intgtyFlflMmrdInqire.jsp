 ...
 * elbi
 *    |_popup
 *        |_oepElbiPopupIntgtyFlflMmrdInqire.jsp
 * 
 * </pre>
 * @date : 2015. 02. 26. 오후 8:23:44
 * @version : 1.0
 * @author : 은우소프트 손연우
 * @date : 2015. 04. 21. 오후 2:42:12
 * @version : 1.1
 * @author : 은우소프트 하성윤
--%>
...
<script type="text/javascript" src="${jsPath}/opro/views/ebid/popup/intgtyFlflMmrdInqire.js"></script>
...
<input type="hidden" id="sessionKey" value="${comFn:getServerCert()}">

<input type="hidden" id=encrandom value="">
<input type="hidden" id=usercert value="">
<input type="hidden" id=enckey value="">
...
<div id="windowPopup">
	<fieldset>
        ...
        <div class="tableLayer">
            <p class="popSubTitle marginSet"> 입찰명 : ${myBidPblancDetail.BID_NM }</p>
                ...
                <tbody>
	                <tr>
	                    <td colspan="4">
	                    	...
	                    	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	                    	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	                    	3.&nbsp;&nbsp;&nbsp;&nbsp;당사는 불공정, 뇌물제공행위가 확인될 경우 협력단이 다음의 조치를 취하더라도 이의를 제기<br>
	                    	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	                    	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	                    	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	                    	하지 않겠음.<br>
      ...
      <font style="text-align: center; font-size: 15px;color: #252525;">한&nbsp;국&nbsp;국&nbsp;제&nbsp;협&nbsp;력&nbsp;단&nbsp;귀&nbsp;중</font>
      <br><br>
	  </div>
        
        <div class="T_btnLayer fr">
        	<c:if test="${empty entrpsInfo.BID_VEND_PSCD or entrpsInfo.BID_VEND_PSCD eq 'OP01'}">
        		<button type="button" class="blueBtn L" id="signBtn">전자서명</button>
        	</c:if>
