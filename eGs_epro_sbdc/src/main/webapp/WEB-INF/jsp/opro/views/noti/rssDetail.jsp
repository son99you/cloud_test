...
<script type="text/javascript" src="${jsPath}/opro/views/noti/rssDetail.js"></script>
...
<div class="contents_wrap">
	...
	<div class="view_wrap typeA">
		<div class="view_area">
			<table>
				...
				<tr>
					<th>내용</th>
					<td colspan="3">
						<textarea id="P_BBS_CNTN" name="P_BBS_CNTN" style="width: 100%; height: 200px;" readonly="readonly">${notiGnrlDetail.BBS_CNTN }</textarea>
					</td>
				</tr>
			</table>
		</div>
		...
		<div class="view_area fileViewer">  <!-- btn_wrap전에 있는 board_write에 m0 추가 -->
					<!-- 업로드 삽입. -->
