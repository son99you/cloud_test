...
public class raonkhandler : IHttpHandler
{
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        ///////////////////////////////
        //업로드 전 이벤트 처리기 등록
        upload.BeforeUploadEvent += new BeforeUploadEventDelegate(BeforeUploadEvent); // Client에서 설정된 Custom Value를 확인하기 위하여 활성화

        //업로드 후 이벤트 처리기 등록
        upload.AfterUploadEvent += new AfterUploadEventDelegate(AfterUploadEvent); // Client에서 설정된 Custom Value를 확인하기 위하여 활성화
